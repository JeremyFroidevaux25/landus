...
## Merge dataset
```{r}
dem<-fread("/Users/jeremyfroidevaux/Documents/Herbiland/CameraTrap/Analysis/Landcover_output/dem_outputVCMsel.csv")
orion<-fread("/Users/jeremyfroidevaux/Documents/Herbiland/CameraTrap/Analysis/Landcover_output/landuse_orion_outputVCMsel.csv")
div<-fread("/Users/jeremyfroidevaux/Documents/Herbiland/CameraTrap/Analysis/Landcover_output/landscapeMetric_outputVCMsel.csv")
camtrap<-fread("/Users/jeremyfroidevaux/Documents/Herbiland/CameraTrap/camerainfo_20231113_sel.csv")
...
ppi <- 150
png("/Users/jeremyfroidevaux/Documents/Herbiland/CameraTrap/Analysis/Plot/Vegetation/lande20_strata.png", width=12*ppi, height=16*ppi, res=ppi)
...
legend<- get_legend(  p1 +   guides(color = guide_legend(nrow = 1)) +
    theme(legend.position = "bottom"))
ppi <- 150
png("/Users/jeremyfroidevaux/Documents/Herbiland/CameraTrap/Analysis/Plot/Vegetation/lande20_canopy.png", width=9*ppi, height=6*ppi, res=ppi)
...
legend<- get_legend(  p1 +   guides(color = guide_legend(nrow = 1)) +
    theme(legend.position = "bottom"))
ppi <- 150
png("/Users/jeremyfroidevaux/Documents/Herbiland/CameraTrap/Analysis/Plot/Vegetation/lande20_shrubspecies.png", width=12*ppi, height=5*ppi, res=ppi)
...
legend<- get_legend(  p1 +   guides(color = guide_legend(nrow = 1)) +
    theme(legend.position = "bottom"))
ppi <- 150
png("/Users/jeremyfroidevaux/Documents/Herbiland/CameraTrap/Analysis/Plot/Vegetation/lande20_herbspecies.png", width=6*ppi, height=6*ppi, res=ppi)
...
legend<- get_legend(  p1 +   guides(color = guide_legend(nrow = 1)) +
    theme(legend.position = "bottom"))
ppi <- 150
png("/Users/jeremyfroidevaux/Documents/Herbiland/CameraTrap/Analysis/Plot/Vegetation/lande20_other.png", width=15*ppi, height=12*ppi, res=ppi)
