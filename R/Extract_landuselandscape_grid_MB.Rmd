...
```{r}
root <- "/Users/jeremyfroidevaux/Library/CloudStorage/GoogleDrive-jfroidevaux@creamontblanc.org/Drive partagés/prototool/herbiland/R_Functions/" 
source(paste(root,"ExtractBufferRaster_KB_JF.r",sep="")) 

extractLandUseRaster( dir.posPoints = "/Users/jeremyfroidevaux/Library/CloudStorage/GoogleDrive-jfroidevaux@creamontblanc.org/Drive partagés/prototool/herbiland/landus/data/gis" ,  
                                ...
                                WorkingDirectory = "/Users/jeremyfroidevaux/Library/CloudStorage/GoogleDrive-jfroidevaux@creamontblanc.org/Drive partagés/prototool/herbiland/landus/output/") 
```

### Part 2: Extract data on landscape configurational and compositional diversity using ORION

```{r}
dir.posPoints = "/Users/jeremyfroidevaux/Library/CloudStorage/GoogleDrive-jfroidevaux@creamontblanc.org/Drive partagés/prototool/herbiland/landus/data/gis"  
name.points = "grid_MB_lande"
...
write.csv(divf, "/Users/jeremyfroidevaux/Library/CloudStorage/GoogleDrive-jfroidevaux@creamontblanc.org/Drive partagés/prototool/herbiland/landus/output/landscapeMetric_outputVCMsel.csv", row.names=FALSE) 
...
```{r}
land<-fread("/Users/jeremyfroidevaux/Library/CloudStorage/GoogleDrive-jfroidevaux@creamontblanc.org/Drive partagés/prototool/herbiland/landus/output/landscapeMetric_outputVCMsel.csv")
hab20<-fread("/Users/jeremyfroidevaux/Library/CloudStorage/GoogleDrive-jfroidevaux@creamontblanc.org/Drive partagés/prototool/herbiland/landus/output/crossedTableRaster_20m.csv")
hab250<-fread("/Users/jeremyfroidevaux/Library/CloudStorage/GoogleDrive-jfroidevaux@creamontblanc.org/Drive partagés/prototool/herbiland/landus/output/crossedTableRaster_250m.csv")
head(land)
head(hab20)
head(hab250)
str(land)
...
write.csv(df, "/Users/jeremyfroidevaux/Library/CloudStorage/GoogleDrive-jfroidevaux@creamontblanc.org/Drive partagés/prototool/herbiland/landus/output/landus_releve_gridMB.csv", row.names=FALSE) 
```
